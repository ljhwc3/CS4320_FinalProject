-- UPDATE
UPDATE users SET user_id = '2', user_name = 'Bruce', u_fname = 'Bruce', u_lname = 'Smith', user_password_hash = '4444444444' WHERE user_email = 'ntctk4@mail.missouri.edu';
...
UPDATE contactInfo SET phone = '098-654-3212', webiste = 'diffrentwebsite.com', address = '309 This is an Address DR.' WHERE email = 'ntctk4@mail.missouri.edu';

UPDATE workExperience SET isCurrent = 'no', dates_worked = '10/10/1995 to 10/10/2009', location = 'St. Louis', jobTitle = 'Worker', job_describtion = 'The job is ok' WHERE email = 'ntctk4@mail.missouri.edu', companyName = 'The Best Place to Work Ever!!';

UPDATE product SET isPublication = 'yes', product_url = 'product.com', discription = 'new publication', isPatent = 'no', isProject = 'no' WHERE email = 'ntctk4@mail.missouri.edu', title = 'THE PROJECT'; 

UPDATE course SET courseName = 'some CS class', location = 'MSU' WHERE email = 'ntctk4@mail.missouri.edu', courseNumber = 'CS-4320';

UPDATE volunteerExp SET dates = '10/10/1995 to 10/10/2009', descriptioin = 'volunteer place to do stuff' WHERE email = 'ntctk4@mail.missouri.edu', organization = 'VolunteerCo';
...
UPDATE job_posting SET industry = 'Education', experience = '10 years', employment_type = 'full time', location = 'St.Louis', description = 'This is a good job', job_title = 'Worker', companyID = 'companyID' WHERE email = 'ntctk4@mail.missouri.edu' applicationURL = 'applicationURL.com';
